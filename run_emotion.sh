SAVE_DIR=/home1/huangrongjie/Project/fairseq-sid-simplify-to-bak/exp/wav2vev2_small_finetune_IEMOCAP_amsoftmax
W2V_PATH=/home1/huangrongjie/Project/fairseq-sid-simplify-to-bak/exp/wav2vec.pt
DATA_DIR=/home1/huangrongjie/Project/fairseq-sid-simplify-to-bak/exp/data/IEMOCAP
...
CUDA_VISIBLE_DEVICES=0,1  python -u train.py $DATA_DIR --save-dir $SAVE_DIR --tensorboard-logdir $SAVE_DIR --fp16 --train-subset train --valid-subset valid --no-epoch-checkpoints --best-checkpoint-metric loss --num-workers 4 \
