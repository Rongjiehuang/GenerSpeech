...
@register_model("wav2vec_amsoftmax")
...
class Wav2VecEncoder(FairseqEncoder):
    def __init__(self, args, tgt_dict=None):
        ...
        self.W = torch.nn.Parameter(torch.randn(768, 1211), requires_grad=True)
...
@register_model_architecture("wav2vec_amsoftmax", "wav2vec_amsoftmax")
