...
class Wav2Vec2Model(BaseFairseqModel):
    ...
    def forward(self, source, padding_mask=None, mask=True, features_only=False):
        ...
        #_, inner_state = self.encoder.extract_features(x, padding_mask=padding_mask)
        if features_only:
            return {"x": x, "padding_mask": padding_mask}
            #return {"x": x, "padding_mask": padding_mask, "inner_state": inner_state}
        ...
        result = {"x": x, "features_out": feats, "padding_mask": padding_mask, "features_pen": features_pen}
    ...
    def extract_features(self, source, padding_mask, mask=False):
        ...
        #return res["x"], res["padding_mask"], res["inner_state"]
